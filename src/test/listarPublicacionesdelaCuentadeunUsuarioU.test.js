...
const {obtenerPublicacionesPorNombre, obtenerUsuarioPorNombredeUsuario, tituloVacio,longitudLista,titulosVacios} = require('OSINTagram/src/Controller/tests.js')
...
beforeAll(async () => {
    lista2 = [
      ...
      lista = obtenerPublicacionesPorNombre(lista2, 'Ana')
}, 25000);
